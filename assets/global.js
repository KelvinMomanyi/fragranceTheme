...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    this.initPages();
    const resizeObserver = new ResizeObserver(debounce((entries) => this.initPages(), 200));
  ...
  initPages() {
    ...
    this.slidesPerPage = Math.floor((geometry.sliderWidth - geometry.item0Offset) / this.sliderItemOffset);
